...
class ZedStreamerServicer(ZedStreamer_pb2_grpc.ZedStreamerServicer):
    def __init__(self, sim_params, connections) -> None:
        self.conn1 = connections[0]
        self.conn2 = connections[1]
        self.conn3 = connections[2]
        self.conn4 = connections[3]
        self.conn5 = connections[4]
        self.conn6 = connections[5]
...
def startServer(sim_params, connections):
    servicer = ZedStreamerServicer(sim_params, connections)
...
def run():
    ...
    connections = [sim_params, zed_parent_con, spikes_parent_con, params_parent_con, depths_parent_con, save_parent_con, save_depth_parent_con]
    p0 = mp.Process(target=startServer, args=(zed_images, connections))
